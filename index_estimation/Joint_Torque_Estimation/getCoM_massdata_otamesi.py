...
for dir in glob.glob(rf'{filepath}\*'):
    ...
    if not dir.endswith("length.csv"):
        ...
        body_measured_d.to_csv(rf'C:\Users\yota0\Desktop\kamiya\program_copy\out\length_csvdeta\{subject}_length2.csv', index=False, header = None)
        ...
        def main():
            data = rf'{filepath}\{subject}_range_correction.csv'
            ...
            csvname = rf'C:\Users\yota0\Desktop\kamiya\program_copy\out\body_measure\{subject}_CoMdata.csv'
            ...
            body_CoM = rf'C:\Users\yota0\Desktop\kamiya\program_copy\out\body_measure\{subject}_BodyCoM.csv'
            body_CoM_csv = open(body_CoM, 'w', newline='')
            writer = csv.writer(body_CoM_csv)
            writer.writerow(['x_CoM', 'y_CoM', 'z_CoM'])

            with open(csvname) as CoM_Series:
            ...
            csvname2 = rf'C:\Users\yota0\Desktop\kamiya\program_copy\out\body_measure\{subject}_Massdata.csv'
